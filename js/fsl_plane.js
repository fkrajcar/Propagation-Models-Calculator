...
$(document).ready(function () { //promjene unosa/mjernih jedinica - ht
    var in_val = "ht_b";
    var sel_val = "ht_sel_b";
    var d_sel_prev = document.getElementById(sel_val).value;
    ...
    $("#sub_but_b").click(function () {
        $('#myform_b').validate({ // pokrenut plugin
            rules: {
                ...
                hr_b: { //minimalno 1 metar za graf
                    required: true,
                    number: true,
                    min: 0.000000001,

                },
                ht_b: { //minimalno 1 metar za graf
                    required: true,
                    number: true,
                    min: 0.000000001,
    ...
    $("#sub_but_c").click(function () {
        $('#myform_c').validate({ // pokrenut plugin
            rules: {
                ...
                ht_c: { //minimalno 1 metar za graf
                    required: true,
                    number: true,
                    min: 0.000000001,

                },
                hr_c: { //minimalno 1 metar za graf
                    required: true,
                    number: true,
                    min: 0.000000001,
